...
QT_MOC_LITERAL(3, 23, 9) // "strCmdOut"

    },
    "CmdThread\0resultReady\0\0strCmdOut"
};
...
void CmdThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CmdThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CmdThread::resultReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CmdThread::staticMetaObject = {
...
// SIGNAL 0
void CmdThread::resultReady(const QString & _t1)
{
