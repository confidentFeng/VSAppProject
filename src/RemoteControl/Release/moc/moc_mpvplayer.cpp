...
QT_MOC_LITERAL(3, 22, 13), // "mpv_palyStart"
QT_MOC_LITERAL(4, 36, 11), // "mpv_palyEnd"
QT_MOC_LITERAL(5, 48, 13) // "on_mpv_events"

    },
    "MpvPlayer\0mpv_events\0\0mpv_palyStart\0"
    "mpv_palyEnd\0on_mpv_events"
};
...
void MpvPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MpvPlayer *_t = static_cast<MpvPlayer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mpv_events(); break;
        case 1: _t->mpv_palyStart(); break;
        case 2: _t->mpv_palyEnd(); break;
        ...
        {
            using _t = void (MpvPlayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MpvPlayer::mpv_palyStart)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MpvPlayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MpvPlayer::mpv_palyEnd)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MpvPlayer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MpvPlayer.data,
      qt_meta_data_MpvPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MpvPlayer::mpv_events()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MpvPlayer::mpv_palyStart()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MpvPlayer::mpv_palyEnd()
{
