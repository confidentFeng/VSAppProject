...
QT_MOC_LITERAL(1, 11, 9), // "EnterSlot"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "LockScreen\0EnterSlot\0"
};
...
void LockScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LockScreen *_t = static_cast<LockScreen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->EnterSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject LockScreen::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LockScreen.data,
      qt_meta_data_LockScreen,  qt_static_metacall, nullptr, nullptr}
};
